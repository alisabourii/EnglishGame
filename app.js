/*const sectors = [
        ...
        { "color": "#0bf", "label": "Cenap Şehabettin" },
        { "color": "#fb1", "label": "Mehmet Akif Ersoy" },
        { "color": "#0fb", "label": "Ahmet Kutsi Tecer" },
        { "color": "#b0f", "label": "Bahriyeli Bahtiyar" },
        { "color": "#f0b", "label": "Hüseyin Nihâl Atsız" },
        { "color": "#bf1", "label": "Arif Nihat Asya" },
        { "color": "#f1b", "label": "Yahya Kemal Beyatlı" },
        ...
        { "color": "#f0b", "label": "Orhan Veli Kanık" },
